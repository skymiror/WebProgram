...
public class UserDAOImpl implements UserDAO {
    ...
    public void insert(User user) throws SQLException {
        ...
        try (Connection conn = DBUtil.getConnection();
            ...
            System.out.println("=== 插入用户失败，账号：" + user.getAccount() + " ===");
            e.printStackTrace();
    ...
    public User findByAccount(String account) throws SQLException {
        ...
        try (Connection conn = DBUtil.getConnection();
            ...
            System.out.println("=== 查询用户失败，账号：" + account + " ===");
            e.printStackTrace();
            throw new SQLException("查询用户失败：" + e.getMessage(), e);
        }
        System.out.println("未找到账号为 " + account + " 的用户");
        return null;
    }
    ...
    public void updateIntro(String account, String newIntroduce) throws SQLException {
        ...
        try (Connection conn = DBUtil.getConnection();
            ...
            int rows = pstmt.executeUpdate();
            System.out.println("更新简介完成！账号：" + account + "，影响行数：" + rows);
        } catch (SQLException e) {
            System.out.println("=== 更新简介失败，账号：" + account + " ===");
            e.printStackTrace();
